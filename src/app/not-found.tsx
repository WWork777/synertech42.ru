    ...
    <>
      ...
      <section className="text-center bg-cover relative overflow-x-hidden" >
        <div className='flex gap-2.5 items-center justify-center'>
          ...
          <p className='text-base font-semibold text-dark/75 text-gray'>
            Error 404
          </p>
        </div>
        <h2 className="text-dark text-52 relative font-bold text-dark " >
          Lost? Let’s Help You Find Home.
        </h2>
        <p className="text-lg text-dark/50 text-gray font-normal w-full mx-auto">
