                    ...
                    <div className="lg:col-span-4 col-span-12">
                        <div className='flex gap-6'>
                            <div className='flex flex-col gap-2 border-e border-black/10 dark:border-white/20 pr-2 xs:pr-4 mobile:pr-6 flex-shrink-0'>
                                <Icon icon={'ph:puzzle-piece'} width={20} height={20} className="text-dark dark:text-white" />
                            ...
                            <div className='flex flex-col gap-2 border-e border-black/10 dark:border-white/20 px-2 xs:px-4 mobile:px-6 flex-shrink-0'>
                                <Icon icon={'ph:cpu'} width={20} height={20} className="text-dark dark:text-white" />
                                <p className='text-sm mobile:text-base font-normal text-black dark:text-white whitespace-nowrap'>
                                    {item?.baths} Датчиков
                                </p>
                            </div>
                ...
                <div className="grid grid-cols-12 gap-8 mt-10">
                    <div className="lg:col-span-8 col-span-12">
                        ...
                        <div className="py-8 my-8 border-y border-dark/10 dark:border-white/20 flex flex-col gap-8">
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <h3 className='text-dark dark:text-white text-xm'>Электронная схемотехника</h3>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <h3 className='text-dark dark:text-white text-xm'>Беспроводная связь</h3>
                                    <p className='text-base text-dark/50 dark:text-white/50'>
                            ...
                            <div className="flex items-center gap-6">
                                ...
                                <div>
                                    <h3 className='text-dark dark:text-white text-xm'>Энергоэффективность</h3>
                                    <p className='text-base text-dark/50 dark:text-white/50'>
                        ...
                        <div className="flex flex-col gap-5">
                            <p className='text-dark dark:text-white text-xm '>
                                Современное измерительное оборудование, разработанное с учетом всех требований ГОСТ и международных стандартов. 
                                Наши устройства отличаются высокой точностью измерений, автономностью работы и надежностью в эксплуатации. 
                                Полный цикл производства от проектирования до серийного выпуска с сопроводительной документацией.
                            </p>
                            <p className='text-dark dark:text-white text-xm '>
                                Каждое устройство проходит многоступенчатый контроль качества и испытания в реальных условиях эксплуатации.
                                Все компоненты подбираются с учётом требований надёжности и долговечности, обеспечивая стабильную работу
                                в течение всего срока службы.
                            </p>
                            <p className='text-dark dark:text-white text-xm '>
                                Разработка проводится с применением современных САПР систем и инструментов моделирования. 
                                Каждый этап производства контролируется для соблюдения стандартов ГОСТ и технических требований заказчика.
                                Готовые изделия проходят полный цикл испытаний перед отгрузкой.
                            </p>
                            <p className='text-dark dark:text-white text-xm '>
                                Мы обеспечиваем полное техническое сопровождение на всех этапах — от проектирования до серийного производства,
                        ...
                        <div className="py-8 mt-8 border-t border-dark/5 dark:border-white/15">
                            ...
                            <div className="grid grid-cols-3 mt-5 gap-6">
                                <div className="flex items-center gap-2.5">
                                    ...
                                    <p className='text-base dark:text-white text-dark'>Беспроводная связь</p>
                                </div>
                                <div className="flex items-center gap-2.5">
                                    <Icon icon="ph:chart-pie-slice" width={24} height={24} className="text-dark dark:text-white" />
                                    <p className='text-base dark:text-white text-dark'>Аналитика данных</p>
                                </div>
                                <div className="flex items-center gap-2.5">
                                    <Icon icon="ph:television-simple" width={24} height={24} className="text-dark dark:text-white" />
                                    <p className='text-base dark:text-white text-dark'>Энергоэффективность</p>
                                </div>
                                <div className="flex items-center gap-2.5">
                                    <Icon icon="ph:sun" width={24} height={24} className="text-dark dark:text-white" />
                                    <p className='text-base dark:text-white text-dark'>Автономная работа</p>
                                </div>
                                <div className="flex items-center gap-2.5">
                                    <Icon icon="ph:video-camera" width={24} height={24} className="text-dark dark:text-white" />
                                    <p className='text-base dark:text-white text-dark'>Системы мониторинга</p>
                                </div>
                                <div className="flex items-center gap-2.5">
                                    <Icon icon="ph:cloud" width={24} height={24} className="text-dark dark:text-white" />
                                    <p className='text-base dark:text-white text-dark'>Облачное хранение</p>
                                </div>
                            </div>
                        </div>
                        <iframe
                    ...
                    <div className="lg:col-span-4 col-span-12">
                        <div className="bg-primary/10 p-8 rounded-2xl relative z-10 overflow-hidden">
                            ...
                            <p className='text-sm text-dark/50 dark:text-white'>Срок выполнения</p>
                            ...
                            <div className="absolute right-0 top-0 opacity-10 -z-[1]">
                                <Icon icon="ph:cpu-bold" width={300} height={300} className="text-primary" />
                            </div>
                        </div>
