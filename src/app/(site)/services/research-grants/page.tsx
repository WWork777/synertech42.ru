...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Полная подготовка научно-исследовательских и опытно-конструкторских работ для участия в грантовых конкурсах',
    details: [
      {
        title: 'Научные исследования',
        description: 'Проведение комплексных научных исследований (НИР) по вашему проекту'
      },
      {
        title: 'Документация',
        description: 'Подготовка документации для НОИКР, патентования и оформления интеллектуальной собственности'
      },
      {
        title: 'Презентация',
        description: 'Подготовка к презентации проекта для комиссий грантовых конкурсов'
      }
    ],
    benefits: [
      'Опыт прохождения конкурсов',
      'Профессиональная НИР',
      'Полная документация НОИКР',
      'Помощь с патентованием',
      'Подготовка презентаций',
      'Увеличение шансов на грант'
    ]
  };
