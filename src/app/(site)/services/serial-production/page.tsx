...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Полная подготовка вашего проекта к переходу в массовое производство с учетом всех требований',
    details: [
      {
        title: 'Документация',
        description: 'Оформление документации в соответствии со всеми требованиями ГОСТа'
      },
      {
        title: 'Подготовка производства',
        description: 'Подготовка линий серийного производства и оптимизация процессов'
      },
      {
        title: 'Контроль качества',
        description: 'Установка систем контроля качества выпускаемой продукции'
      }
    ],
    benefits: [
      'Полная ГОСТ документация',
      'Оптимизация производственных процессов',
      'Подготовка линий производства',
