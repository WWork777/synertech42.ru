...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Профессиональная обработка металла с использованием современного оборудования ЧПУ и электроэрозионной обработки',
    details: [
      {
        title: 'ЧПУ фрезеровка',
        description: 'Изготовление металлических узлов и элементов методом прецизионной ЧПУ фрезеровки'
      },
      {
        title: 'Электроэрозионная обработка',
        description: 'Электроэрозионная обработка металла для создания сложных форм и точных размеров'
      },
      {
        title: 'Контроль качества',
        description: 'Полный контроль качества выполненных работ и соответствие техническим требованиям'
      }
    ],
    benefits: [
