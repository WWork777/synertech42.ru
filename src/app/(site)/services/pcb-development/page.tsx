...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Профессиональная разработка и изготовление печатных плат любой сложности для различных применений',
    details: [
      {
        title: 'Разработка схемы',
        description: 'Разработка электрической схемы и выбор оптимальных компонентов для вашего проекта'
      },
      {
        title: 'Проектирование плат',
        description: 'Профессиональное проектирование печатных плат с учетом индивидуальных запросов и требований'
      },
      {
        title: 'Изготовление',
        description: 'Высокопрецизионное изготовление односторонних и двусторонних печатных плат'
      }
    ],
    benefits: [
      'Поддержка всех типов печатных плат',
      'Точное соответствие техническим требованиям',
