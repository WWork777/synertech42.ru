...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Полный цикл изготовления пластиковых изделий методом холодного литья в силиконовые формы',
    details: [
      {
        title: 'Мастер модель SLA',
        description: 'Изготовление мастер модели путем современной SLA 3D печати'
      },
      {
        title: 'Силиконовые формы',
        description: 'Изготовление долговечных силиконовых форм любой необходимой твердости'
      },
      {
        title: 'Холодное литье',
        description: 'Изготовление пластиковых изделий путем холодного литья различных смол'
      }
    ],
    benefits: [
      'Сложные геометрические формы',
      'Долговечные силиконовые формы',
      'Различные материалы для литья',
      'Быстрое изготовление серий',
