...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Полный цикл разработки прототипов от идеи до готового опытного образца с тестированием',
    details: [
      {
        title: 'Техническое задание',
        description: 'Составление подробного Технического Задания для разработки вашего проекта'
      },
      {
        title: 'Разработка прототипов',
        description: 'Разработка прототипов лабораторных устройств для первичного тестирования гипотез'
      },
      {
        title: 'Опытные образцы',
        description: 'Разработка опытных образцов на основе результатов тестирования с полной готовностью'
      }
    ],
    benefits: [
      'От идеи к готовому образцу',
