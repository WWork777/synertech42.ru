...
export default function ServiceDetailPage() {
  const service = {
    ...
    description: 'Комплексная разработка встроенных систем с программированием микроконтроллеров и программируемых логических контроллеров',
    details: [
      {
        title: 'Подбор компонентов',
        description: 'Профессиональный подбор микроконтроллера и прочих узлов под конкретную задачу'
      },
      {
        title: 'Программирование',
        description: 'Разработка качественного кода для микроконтроллеров и ПЛК с полной оптимизацией'
      },
      {
        title: 'Интеграция и тестирование',
        description: 'Разработка интерфейсов графических панелей, оформление документации, сборка и монтаж'
      }
    ],
    benefits: [
      'Опыт с различными платформами',
      'Оптимальный выбор решений',
      'Полная документация проекта',
      'Графические интерфейсы панелей',
      'Полная сборка и интеграция',
