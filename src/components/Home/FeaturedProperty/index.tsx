                    ...
                    <div className="rounded-xl sm:rounded-2xl w-full h-[350px] sm:h-[400px] md:h-[450px] lg:h-[530px] bg-gradient-to-br from-gray-50 to-white flex items-center justify-center relative overflow-hidden border border-gray-100">
                        ...
                        <svg className="w-full h-full" xmlns="http://www.w3.org/2000/svg">
                          <defs>
                            ...
                            >
                              ...
                              <line x1="0" y1="0" x2="50" y2="50" stroke="#E83C39" strokeWidth="1" />
                              <line x1="100" y1="0" x2="50" y2="50" stroke="#E83C39" strokeWidth="1" />
                              <line x1="0" y1="100" x2="50" y2="50" stroke="#E83C39" strokeWidth="1" />
                              <line x1="100" y1="100" x2="50" y2="50" stroke="#E83C39" strokeWidth="1" />
                            </pattern>
                          </defs>
                      ...
                      <div className="relative z-10 flex flex-col items-center gap-8">
                        ...
                        <div className="text-center">
                          <p className="text-gray-500 text-xs sm:text-sm font-medium mb-1">ИЗБРАННЫЙ ПРОЕКТ</p>
                          <p className="text-dark text-xl sm:text-2xl font-semibold">№ {index + 1}</p>
                        </div>
                      </div>
