      ...
      <div className='bg-gradient-to-b from-primary/10 via-primary/5 to-white/10 overflow-hidden relative'>
        <div className='container max-w-8xl mx-auto px-4 sm:px-5 lg:px-5 2xl:px-0 pt-16 sm:pt-24 md:pt-60 pb-12 sm:pb-16 md:pb-68'>
          <div className='relative text-dark text-center md:text-start z-10'>
            <p className='text-inherit text-xs sm:text-xm font-medium'>Центр прототипирования полного цикла</p>
            ...
            <div className='flex flex-col sm:flex-row justify-center md:justify-start gap-3 sm:gap-4'>
              <Link href="/contactus" className='px-6 sm:px-8 py-3 sm:py-4 border border-primary bg-primary text-white duration-300 hover:bg-primary-hover text-sm sm:text-base font-semibold rounded-full hover:cursor-pointer whitespace-nowrap'>
                Получить консультацию
              </Link>
              <Link href="/properties" className='px-6 sm:px-8 py-3 sm:py-4 border border-primary bg-white text-dark hover:bg-primary hover:text-white duration-300 text-sm sm:text-base font-semibold rounded-full hover:cursor-pointer whitespace-nowrap'>
                Портфолио проектов
              </Link>
            </div>
          </div>
          ...
          <div className='grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 lg:flex gap-6 sm:gap-8 md:gap-12 lg:gap-24 sm:text-center text-dark'>
            <div className='flex flex-col sm:items-center gap-2 sm:gap-3'>
              <div className='w-6 sm:w-7 md:w-8 h-6 sm:h-7 md:h-8 flex items-center justify-center flex-shrink-0'>
                <svg className='w-full h-full text-inherit' fill='none' stroke='currentColor' viewBox='0 0 24 24'>
