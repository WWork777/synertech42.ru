      ...
      <div className="container mx-auto max-w-8xl pt-8 sm:pt-12 md:pt-14 px-4 sm:px-5 lg:px-5 2xl:px-0">
          ...
          <div className="grid grid-cols-12 sm:gap-10 gap-y-6">
            <div className="md:col-span-7 col-span-12">
              ...
              <p className="text-white/80 text-sm sm:text-base md:text-lg mb-4 sm:mb-6">
                Разработка и прототипирование под ключ с соблюдением всех стандартов и требований
              </p>
              <Link href="/contactus" className="bg-white text-base font-semibold py-4 px-8 rounded-full text-dark hover:bg-dark hover:text-white duration-300 hover:cursor-pointer">
                Связаться с нами
              </Link>
            </div>
        ...
        <div className="flex justify-between md:flex-nowrap flex-wrap items-center py-6 gap-6">
          ...
          <div className="flex gap-8 items-center">
            <Link href="/terms" className="text-white/40 hover:text-white text-sm duration-300">
              Условия использования
            </Link>
            <Link href="/privacy" className="text-white/40 hover:text-white text-sm duration-300">
              Политика конфиденциальности
            </Link>
          </div>
          <Link 
            href="https://t.me/sinertek" 
            target="_blank"
